  ...
  return (
    <div className="relative">
      <PhoneInput
        ...
        className={`flex ${className ?? "my-6"} px-2.5 pt-2 pb-0.5 w-full text-sm text-primary placeholder:text-blue-600 bg-transparent rounded-lg border border-primary appearance-none focus:outline-none peer`}
      />
