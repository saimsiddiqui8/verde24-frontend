...
export const schema2 = z.object({
  ...
  special_instruction: z
    .string()
    .min(1, { message: "Special instruction is required" }),
});
...
const Communication = () => {
  ...
  const onSubmit1: SubmitHandler<ClinicalFormData> = (
  ...
  const onSubmit2: SubmitHandler<PrescriptionFormData> = (
  ...
  return (
    <DashboardSection>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        >
          <h3 className="text-2xl font-extrabold text-[#3FB946] mb-4">
            Details
          </h3>
            ...
            <div key={index}>
              {input.type === "select" ? (
                <DropdownField
                  ...
                  properties={{
                    ...register1(input.name as keyof ClinicalFormData),
                  }}
            ...
            <div key={index}>
              {input.type === "select" ? (
                <DropdownField
                  ...
                  options={input.options!}
                  properties={{
                    ...register2(input.name as keyof PrescriptionFormData),
                  }}
                  error={
                    errors2[input.name as keyof PrescriptionFormData]?.message
                  }
                />
              ) : (
                <InputField
