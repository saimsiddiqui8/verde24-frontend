...
import { addPatientdetail, clearAlllabTests, deleteLabDetail } from "../../../../redux/slices/LabBooking";
...
{(data ?? [])?.map((item:labTests, index:number) => (
  <div key={index} className="w-full lg:w-3/6 bg-white p-6 md:p-8 border-2 border-[#3FB946] rounded-3xl mt-6 lg:mt-16 h-full flex flex-col justify-center">
    ...
    <div className="pb-2 mb-4">
      ...
      <p className="text-primary text-gray-600 leading-5">{item.description}</p>
    </div>
