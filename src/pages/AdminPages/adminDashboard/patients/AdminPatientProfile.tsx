...
export default function AdminPatientProfile() {
  ...
  >
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 my-2">
      <div className="flex flex-col lg:flex-row items-start justify-start text-xs font-bold gap-2">
        ...
        <span>
          {patientData?.data?.image ? (
            <ImageUrl fileKey={patientData?.data?.image} className="w-24 h-24" />
          ) : (
            "Not updated"
          )}
        </span>
      ...
      <div className="flex flex-col lg:flex-row items-start justify-start text-xs font-bold gap-2">
        <span>Banned:</span>
        <span>{patientData?.data?.is_verified ? "Patient is banned" : "Not banned"}</span>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-start justify-start text-xs font-bold gap-2">
        ...
        <span>{patientData?.data?.age ? patientData?.data?.age : "Not updated"}</span>
      </div>
  
      <div className="flex flex-col lg:flex-row items-start justify-start text-xs font-bold gap-2">
        <span className="whitespace-nowrap">Weight:</span>
        <span>{patientData?.data?.weight ? patientData?.data?.weight : "Not updated"}</span>
      </div>
