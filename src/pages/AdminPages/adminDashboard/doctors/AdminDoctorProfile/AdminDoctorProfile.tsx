...
import { DOCTOR_QUERY, DOCTOR_UPDATE_QUERY } from "./queries";
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-2 items-start">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-start text-xs font-bold gap-2">
          ...
          <span>
            {doctorData?.data?.consultation_fee_regular || "Not updated"}
          </span>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-start justify-start text-xs font-bold gap-2">
          ...
          <span>
            {doctorData?.data?.consultation_fee_discounted || "Not updated"}
          </span>
        </div>
