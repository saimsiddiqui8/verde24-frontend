...
import { FindAppointmentByStatus, UpdateLabAppointmentStatus } from "../../../../api/apiCalls/labApi";
import { FIND_APPOINTMENT_BY_STATUS, UPDATE_LAB_APPOINTMENT_STATUS } from "./queries";
...
const { data } = useQuery({
  ...
  const updatelabstatus = (AppointmentID:number)=>{
    return UpdateLabAppointmentStatus(UPDATE_LAB_APPOINTMENT_STATUS,{updateLabAppointmentStatusId:AppointmentID,status:"Approved"})
  }
